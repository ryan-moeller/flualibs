...
#define DEFINE(ident) ({ \
	...
	DEFINE(CTLFLAG_WR);
	DEFINE(CTLFLAG_RW);
	DEFINE(CTLFLAG_DORMANT);
	DEFINE(CTLFLAG_ANYBODY);
	DEFINE(CTLFLAG_SECURE);
	DEFINE(CTLFLAG_PRISON);
	DEFINE(CTLFLAG_DYN);
	DEFINE(CTLFLAG_SKIP);
	DEFINE(CTLMASK_SECURE);
	DEFINE(CTLFLAG_TUN);
	DEFINE(CTLFLAG_RDTUN);
	DEFINE(CTLFLAG_RWTUN);
	DEFINE(CTLFLAG_MPSAFE);
	DEFINE(CTLFLAG_VNET);
	DEFINE(CTLFLAG_DYING);
	DEFINE(CTLFLAG_CAPRD);
	DEFINE(CTLFLAG_CAPWR);
	DEFINE(CTLFLAG_STATS);
	DEFINE(CTLFLAG_NOFETCH);
	DEFINE(CTLFLAG_CAPRW);
	DEFINE(CTLFLAG_NEEDGIANT);
	DEFINE(CTLSHIFT_SECURE);
	DEFINE(CTLFLAG_SECURE1);
	DEFINE(CTLFLAG_SECURE2);
	DEFINE(CTLFLAG_SECURE3);
