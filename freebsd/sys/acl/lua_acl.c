...
int luaopen_freebsd_sys_acl(lua_State *);
...
int
luaopen_freebsd_sys_acl(lua_State *L)
{
...
#define SETCONST(ident) ({ \
	...
	SETCONST(MAX_ENTRIES);

	SETCONST(BRAND_UNKNOWN);
	SETCONST(BRAND_POSIX);
	SETCONST(BRAND_NFS4);

	SETCONST(UNDEFINED_TAG);
	SETCONST(USER_OBJ);
	SETCONST(USER);
	SETCONST(GROUP_OBJ);
	SETCONST(GROUP);
	...
	SETCONST(ENTRY_TYPE_ALLOW);
	SETCONST(ENTRY_TYPE_DENY);
	SETCONST(ENTRY_TYPE_AUDIT);
	SETCONST(ENTRY_TYPE_ALARM);

	SETCONST(TYPE_ACCESS_OLD);
	SETCONST(TYPE_DEFAULT_OLD);
	SETCONST(TYPE_ACCESS);
	SETCONST(TYPE_DEFAULT);
	SETCONST(TYPE_NFS4);
	...
	SETCONST(PERM_NONE);
	SETCONST(PERM_BITS);
	SETCONST(POSIX1E_BITS);

	SETCONST(READ_DATA);
	SETCONST(LIST_DIRECTORY);
	SETCONST(WRITE_DATA);
	SETCONST(ADD_FILE);
	SETCONST(APPEND_DATA);
	SETCONST(ADD_SUBDIRECTORY);
	SETCONST(READ_NAMED_ATTRS);
	SETCONST(WRITE_NAMED_ATTRS);
	SETCONST(DELETE_CHILD);
	SETCONST(READ_ATTRIBUTES);
	SETCONST(WRITE_ATTRIBUTES);
	SETCONST(DELETE);
	SETCONST(READ_ACL);
	SETCONST(WRITE_ACL);
	SETCONST(WRITE_OWNER);
	SETCONST(SYNCHRONIZE);
	...
	SETCONST(NFS4_PERM_BITS);

	SETCONST(FIRST_ENTRY);
	SETCONST(NEXT_ENTRY);

	SETCONST(ENTRY_FILE_INHERIT);
	SETCONST(ENTRY_DIRECTORY_INHERIT);
	SETCONST(ENTRY_NO_PROPAGATE_INHERIT);
	SETCONST(ENTRY_INHERIT_ONLY);
	SETCONST(ENTRY_SUCCESSFUL_ACCESS);
	SETCONST(ENTRY_FAILED_ACCESS);
	SETCONST(ENTRY_INHERITED);

	SETCONST(FLAGS_BITS);

	SETCONST(UNDEFINED_ID);

	SETCONST(TEXT_VERBOSE);
	SETCONST(TEXT_NUMERIC_IDS);
	SETCONST(TEXT_APPEND_ID);

	SETCONST(OVERRIDE_MASK);
	SETCONST(PRESERVE_MASK);
#undef SETCONST
	return (1);
}
