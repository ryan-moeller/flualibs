...
#define SETCONST(ident) ({ \
	...
	SETCONST(TYPE_NONE);
	SETCONST(TYPE_BOOL);
	SETCONST(TYPE_NUMBER);
	SETCONST(TYPE_STRING);
	SETCONST(TYPE_NVLIST);
	SETCONST(TYPE_DESCRIPTOR);
	SETCONST(TYPE_BINARY);
	SETCONST(TYPE_BOOL_ARRAY);
	SETCONST(TYPE_NUMBER_ARRAY);
	SETCONST(TYPE_STRING_ARRAY);
	SETCONST(TYPE_NVLIST_ARRAY);
	SETCONST(TYPE_DESCRIPTOR_ARRAY);
	SETCONST(FLAG_IGNORE_CASE);
	SETCONST(FLAG_NO_UNIQUE);
#undef SETCONST
	return (1);
}
